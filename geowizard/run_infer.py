# Code Adpated for esimation of Normals(also .npy files are removed)
import argparse
import os
import logging
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run Normal Estimation using Stable Diffusion."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="Spectral",
        help="Colormap used to render normal predictions.",
    )
    # other settings
    ...
    with torch.no_grad():
        ...
        for test_file in tqdm(test_files, desc="Estimating Normal", leave=True):
